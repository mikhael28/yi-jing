...
export const hexagrams: Hexagram[] = [
  {
    ...
    judgement: [
      ...
      'In relation to the human sphere, this shows how the great man brings peace and security to the world through his activity in creating order: "They towers high above the multitude of beings, and all lands are united in peace."',
    ],
    image: [
    ...
    lines: [
      ...
      "In China the dragon has a meaning altogether different from that given it in the Western world. The dragon is a symbol of the electrically charged, dynamic, arousing force that manifests itself in the thunderstorm. In winter this energy withdraws into the earth; in the early summer it becomes active again, appearing in the sky as thunder and lightning. As a result the creative forces on earth begin to stir again. Here this creative force is still hidden beneath the earth and therefore has no effect. In terms of human affairs, this symbolizes a great man who is still unrecognized. Nonetheless they remains true to himself. They does not allow himself to be influenced by outward success or failure, but confident in his strength, they bides his time. Hence it is wise for the man who consults the oracle and draws this line to wait in the calm strength of patience. The time will fulfill itself. One need not fear least strong will should not prevail; the main thing is not to expend one's powers prematurely in an attempt to obtain by force something for which the time is not yet ripe.",
      'Nine in the second place means:\rDragon appearing in the field.\rIt furthers one to see the great man.',
      'Here the effects of the light-giving power begin to manifest themselves. In terms of human affairs, this means that the great man makes his appearance in his chosen field of activity. As yet they has no commanding position but is still with his peers. However, what distinguishes him form the others is his seriousness of purpose, his unqualified reliability, and the influence they exerts on his environment with out conscious effort. Such a man is destined to gain great influence and to set the world in order. Therefore it is favorable to see him.',
      ...
      'A sphere of influence opens up for the great man. His fame begins to spread. The masses flock to him. His inner power is adequate to the increased outer activity. There are all sorts of things to be done, and when others are at rest in the evening, plans and anxieties press in upon him. But danger lurks here at the place of transition from lowliness to the heights. Many a great man has been ruined because the masses flocked to him and swept him into their course. Ambition has destroyed his integrity. However, true greatness is not impaired by temptations. They who remains in touch with the time that is dawning, and with its demands is prudent enough to avoid all pitfalls, and remains blameless.',
      'Nine in the fourth place means:\rWavering flight over the depths.\rNo blame.',
      'A place of transition has been reached, and free choice can enter in. A twofold possibility is presented to the great man: they can soar to the heights and play an important part in the world, or they can withdraw into solitude and develop himself. They can go the way of the hero or that of the holy sage who seeks seclusion. There is no general law of his being. If the individual acts consistently and is true to himself, they will find the way that is appropriate for him. This way is right for him and without blame.',
      ...
      "When a man seeks to climb so high that they loses touch with the rest of mankind, they becomes isolated, and this necessarily leads to failure. This line warns against titanic aspirations that exceed one's power. A precipitous fall would follow.",
  ...
  },
  {
    ...
    binary: '000000',
    lines_string: '000000',
    line_numbers: [0, 0, 0, 0, 0, 0],
    description:
      'The Earth contains and sustains. In this situation, the Superior Person should not take the initiative; they should follow the initiative of another. The wise follow the natural path of calmness and correct persistence. They should seek receptive allies in the southwest; they should break ties with immovable allies in the northeast. Responsive devotion. Receptive influence. Sublime success if you keep to your course.',
    ...
    judgement: [
      'THE RECEPTIVE brings about sublime success,\rFurthering through the perseverance of a mare.\rIf the superior man undertakes something and tries to lead,\rHe goes astray;\rBut if they follows, they finds guidance.\rIt is favorable to find friends in the west and south,\rTo forego friends in the east and north.\rQuiet perseverance brings good fortune.',
      ...
      "Only because nature in its myriad forms corresponds with the myriad impulses of the Creative can it make these impulses real. Nature's richness lies in its power to nourish all living things; its greatness lies in its power to give then beauty and splendor. Thus it prospers all that lives. IT is the Creative that begets things, but they are brought to birth by the Receptive. Applied to human affairs, therefore, what the hexagram indicated is action in conformity with the situation. The person in questions not in an independent position, but is acting as an assistant. This means that they must achieve something. It is not his task to try to lead--that would only make him lose the way-but to let himself be led. If they knows how to meet fate with an attitude of acceptance, they is sure to find the right guidance. The superior man lets himself be guided; they does not go ahead blindly, but learns from the situation what is demanded of him and then follows this intimation from fate.",
    ],
    image: [
    ...
    lines: [
      ...
      'The symbol of heaven is the circle, and that of earth is the square. Thus squareness is a primary quality of the earth. On the other hand, movement in a straight line, as well as magnitude, is a primary quality of the Creative. But all square things have their origin in a straight line and into turn form solid bodies. In mathematics, when we discriminate between lines, planes and solids, we find that rectangular planes result from straight lines, and cubic magnitudes from rectangular planes. The Receptive accommodates itself to the qualities of the Creative and makes them its own. Thus a square develops out of a straight line and a cube out of a square. This is compliance with the laws of the Creative; nothing is taken away, nothing added. Therefore the Receptive has no need of a special purpose of its own, nor of any effort, yet everything turns out as it should. Nature creates all beings without erring: this is its foursquareness. It tolerates all creatures equally: this is its greatness. Therefore it attains what is right for all without artifice or special intentions. Man achieves the height of wisdom when all that they does is as self-evident as what nature does.',
      ...
      'If a man is free of vanity they is able to conceal his abilities and keep them from attracting attention too soon; thus they can mature undisturbed. If conditions demand it, they can also enter public life, but that too they does with restraint. The wise man gladly leaves fame to others. They does not seek to have credited to himself things that stand accomplished, but hopes to release active forces; that is, they completes his works in such a manner that they may bear fruit for the future.',
      'Six in the fourth place means:\rA tied-up sack.\rNo blame, no praise.',
      'The dark element opens when it moves and closes when at rest. The strictest reticence is indicated here. The time is dangerous , because any degree of prominence leads either to the enmity of irresistible antagonists if one challenges them or to misconceived recognition if one is complaisant. Therefore a man ought to maintain reserve, be it in solitude or in the turmoil of the world, for there too they can hide himself so well that no one knows him.',
  ...
  },
  {
    ...
    lines: [
      ...
      'If a person encounters a hindrance at the beginning of an enterprise, they must not try to force advance but must pause and take thought. However, nothing should put him off his course; they must persevere and constantly keep the goal in sight. It is important to seek out the right assistants, but they can find them only if they avoids arrogance and associated with his fellows in a spirit of humility. Only then will they attract those with whose help they can combat the difficulties.',
      'Six in the second place means:\rDifficulties pile up.\rHorse and wagon part.\rHe is not a robber;\rHe wants to woo when the time comes.\rThe maiden is chaste,\rShe does not pledge herself.\rTen years--then they pledges herself.',
      'We find ourselves beset by difficulties and hindrances. Suddenly there is a turn of affairs, as if someone were coming up with a horse and wagon and unhitching them. This event comes so unexpectedly that we assume the newcomer to be a robber. Gradually it becomes clear that they has no evil intentions but seeks to be friendly and to offer help. But this offer is not to be accepted, because it does not come from the right quarter. We must wait until the time is fulfilled; ten years is a fulfilled cycle of time. Then normal conditions return of themselves, and we can join forces with the friend intended for us.',
  ...
  },
  {
    ...
    judgement: [
      'YOUTHFUL FOLLY has success.\rIt is not I who seek the young fool;\rThe young fool seeks me.\rAt the first oracle I inform him.\rIf they asks two or three times, it is importunity.\rIf they importunes, I give him no information.\rPerseverance furthers.',
      'In the time of youth, folly is not an evil. One may succeed in spite of it, provided one finds an experienced teacher and has the right attitude toward him. This means, first of all, that the youth himself must be conscious of his lack of experience and must seek out the teacher. Without this modesty and this interest there is no guarantee that they has the necessary receptivity, which should express itself in respectful acceptance of the teacher. This is the reason why the teacher must wait to be sought out instead of offering himself. Only thus can the instruction take place at the right time and in the right way.',
    ],
    image: [
      'A spring wells up at the foot of the mountain:\rThe image of YOUTH.\rThus the superior man fosters his character\rBy thoroughness in all that they does.',
    ],
    lines: [
      ...
      'These lines picture a man who has no external power, but who has enough strength of mind to bear his burden of responsibility. They has the inner superiority and that enable him to tolerate with kindliness the shortcomings of human folly. The same attitude is owed to women as the weaker sex. One must understand them and give them recognition in a spirit of chivalrous consideration. Only this combination of inner strength with outer reserve enables one to take on the responsibility of directing a larger social body with real success.',
      'Six in the third place means:\rTake not a maiden who.\rWhen they sees a man of bronze,\rLoses possession of herself.\rNothing furthers.',
      'A weak, inexperienced man, struggling to rise, easily loses his own individuality when they slavishly imitates a strong personality of higher station. They is like a girl throwing herself away when they meets a strong man. Such a servile approach should not be encouraged, because it is bad both for the youth and the teacher. A girl owes it to her dignity to wait until they is wooed. In both cases it is undignified to offer oneself, and no good comes of accepting such an offer.',
  ...
  },
  {
    ...
    binary: '111010',
    lines_string: '010111',
    line_numbers: [0, 1, 0, 1, 1, 1],
    description:
      'The high Heavens over a yawning Deep chasm: an expansive void where nothing can dwell. Even though they sincerely knows they is right, the Superior Person anticipates opposition and carefully prepares for any incident. Good fortune if your conflict results in compromise. Misfortune if your conflict escalates to confrontation. Seek advice. Postpone your crossing to the far shore.',
    ...
    lines: [
      ...
      'In a struggle with an enemy of superior strength, retreat is no disgrace. Timely withdrawal prevents bad consequences. If, out of a false sense of honor, a man allowed himself to be tempted into an unequal conflict, they would be drawing down disaster upon himself. In such a case a wise and conciliatory attitude benefits the whole community, which will then not be drawn into the conflict.',
      ...
      'This refers to a person whose inner attitude at first lacks peace. They does not feel content with his situation and would like to improve it through conflict. In contrast to the situation of the nine in the second place, they is dealing with a weaker opponent and might therefore succeed. But they cannot carry on the fight, because, since right is not on his side, they cannot justify the conflict to his conscience. Therefore they turns back and accepts his fate. They changes his mind and finds lasting peace in being at one with eternal law. This brings good fortune.',
  ...
  },
  {
    ...
    lines: [
      ...
      'The leader should be in the midst of his army, in touch with it, sharing good and bad with the masses they leads. This alone makes him equal to the heavy demands made upon him. They needs also the recognition of the ruler. The decorations they receives are justified, because there is no question of personal preferment here: the whole army, whose center they is, is honored in his person.',
  ...
  },
  {
    ...
    judgement: [
      ...
      'What is required is that we unite with others, in order that all may complement and aid one another through holding together. But such holding together calls for a central figure around whom other persons may unite. To become a center of influence holding people together is a grave matter and fraught with great responsibility. It requires greatness of spirit, consistency, and strength. Therefore let him who wishes to gather others about him ask himself whether they is equal to the undertaking, for anyone attempting the task without a real calling for it only makes confusion worse than if no union at all had taken place.',
      'But when there is a real rallying point, those who at first are hesitant or uncertain gradually come in of their own accord. Late-comers must suffer the consequences, for in holding together the question of the right time is also important. Relationships are formed and firmly established according to definite inner laws. Common experiences strengthen these ties, and they who comes too late to share in these basic experiences must suffer for it if, as a straggler, they finds the door locked.',
    ],
    image: [
    ...
    lines: [
      ...
      'If a person responds perseveringly and in the right way to the behests from above that summon him to action, his relations with others are intrinsic and they does not lose himself. But if a man seeks association with others as if they were an obsequious office hunter, they throws himself away. They does not follow the path of the superior man, who never loses his dignity.',
  ...
  },
  {
    ...
    binary: '110111',
    lines_string: '111011',
    line_numbers: [1, 1, 1, 0, 1, 1],
    description:
      'Winds of change high in the Heavens: Air currents carry the weather. Dense clouds blow in from the west, but still no rain. The Superior Person fine tunes the image they presents to the world. Small successes.',
  ...
  },
  {
    ...
    lines: [
      ...
      'The meaning of the hexagram is not standstill but progress. A man finds himself in an altogether inferior position at the start. However, they has the inner strength that guarantees progress. If they can be content with simplicity, they can make progress without blame. When a man is dissatisfied with modest circumstances, they is restless and ambitious and tries to advance, not for the sake of accomplishing anything worth while, but merely in order to escape from lowliness and poverty by dint of his conduct. Once his purpose is achieved, they is certain to become arrogant and luxury-loving. Therefore blame attaches to his progress. On the other hand, a man who is good at his work is content to behave simply. They wishes to make progress in order to accomplish something. When they attains his goal, they does something worth while, an all is well.',
      'Nine in the second place means:\rTreading a smooth, level course.\rThe perseverance of a dark man\rBrings good fortune.',
      'The situation of a lonely sage is indicated here. They remains withdrawn from the bustle of life, seeks nothing, asks nothing of anyone, and travels through life unassailed, on a level road. Since they is content and does not challenge fate, they remains free of entanglements.',
      ...
      "A one-eyed man can indeed see, but not enough for clear vision. A lame man can indeed treat, but not enough to make progress. If in spite of such defects a man considers himself strong and consequently exposes himself to danger, they is inviting disaster, for they is undertaking something beyond his strength. This reckless way of plunging ahead, regardless of the adequacy of one's powers, can be justified only in the case of a warrior battling for his prince.",
  ...
  },
  {
    ...
    lines: [
      ...
      'Inferior people are ready to flatter their superiors in a servile way. They would also endure the superior man if they would put an end to their confusion. This is fortunate for them. But the great man calmly bears the consequences of the standstill. They does not mingle with the crowd of the inferior; that is not his place. By his willingness to suffer personally they insures the success of his fundamental principles.',
      ...
      'Nine in the fifth place means:\rStandstill is giving way.\rGood fortune for the great man.\r"What if it should fail, what if it should fail?"\rIn this way they ties it to a cluster of mulberry shoots.',
  ...
  },
  {
    ...
    lines: [
      ...
      'A magnanimous, liberal-minded man should not regard what they possesses as his exclusive personal property , but should place it at the disposal of the ruler or of the people at large. In so doing, they takes the right attitude toward his possession, which as private property can never endure. A petty man is incapable of this. They is harmed by great possessions, because instead of sacrificing them, they would keep them for himself.',
      'Nine in the fourth place means:\rHe makes a difference\rBetween himself and his neighbor.\rNo blame.',
      'This characterizes the position of a man placed among rich and powerful neighbors. It is a dangerous position. They must look neither to the right nor to the left, and must shun envy and the temptation to vie with others. In this way they remains free of mistakes.',
  ...
  },
  {
    ...
    lines: [
      ...
      'A man in an inferior position has aristocratic connections about which they boasts enthusiastically. This arrogance inevitably invites misfortune. Enthusiasm should never be an egotistic emotion; it is justified only when it is a general feeling that unites one with others.',
      'Six in the second place means:\rFirm as a rock.\rNot a whole day.\rPerseverance brings good fortune.',
      'This describes a person who does not allow himself to be misled by any illusions. While others are letting themselves be dazzled by enthusiasm, they recognizes with perfect clarity the first signs of the time. Thus they neither flatters those above nor neglects those beneath him; they is as firm as a rock. When the first sign of discord appears, they knows the right moment for withdrawing and does not delay even for a day. Perseverance in such conduct will bring good fortune. Confucius says about this line:',
      'To know the seeds, that is divine indeed. In his association with those above him, the superior man does not flatter. In his association with those beneath him, they is not arrogant. For they knows the seeds. The seeds are the first imperceptible beginning of movement, the first trace of good fortune (or misfortune) that shows itself. The superior man perceives the seeds and immediately takes action. They does not wait even a whole day. In the Book of Changes it is said: "Firm as a rock. Not a whole day. Perseverance brings good fortune." Firm as a rock, what need of a whole day? The judgment can be known. The superior man knows what is hidden and what is evident. They knows weakness, they knows strength as well. Hence the myriads look up to him.',
      'Six in the third place means:\rEnthusiasm that looks upward creates remorse.\rHesitation brings remorse.',
      'This line is the opposite of the preceding one: the latter bespeaks self-reliance, while here there is enthusiastic looking up to a leader. If a man hesitates too long, this also will bring remorse. The right moment for approach must be seized: only then will they do the right thing.',
      ...
      'This describes a man who is able to awaken enthusiasm through his own sureness and freedom from hesitation. They attracts people because they has no doubts and is wholly sincere. Owing to his confidence in them they wins their enthusiastic co-operation and attains success. Just as a clasp draws the hair together and hold it, so they draws man together by the support they gives them.',
  ...
  },
  {
    ...
    summary:
      'The trigram Tui, the Joyous, whose attribute is gladness, is above; Ch&ecirc;n, the Arousing, which has the attribute of movement, is below. Joy in movement induces following. The Joyous is the youngest daughter, while the Arousing is the eldest son. An older man defers to a young girl and shows her consideration. By this they moves her to follow him.',
    judgement: [
      'FOLLOWING has supreme success.\rPerseverance furthers.\rNo blame.',
      'In order to obtain a following one must first know how to adapt oneself. If a man would rule they must first learn to serve, for only in this way does they secure from those below him the joyous assent that is necessary if they are to follow him. If they has to obtain a following by force or cunning, by conspiracy or by creating faction, they invariably arouses resistance, which obstructs willing adherence. But even joyous movement can lead to evil consequences, hence the added stipulation, "Perseverance furthers" --that is, consistency in doing right-- together with "No blame." Just as we should not ask others to follow us unless this condition is fulfilled, so it is only under this condition that we can in turn follow others without coming to harm.',
    ],
    image: [
    ...
    lines: [
      ...
      'When the right connection with distinguished people has been found, a certain loss naturally ensues. A man must part company with the inferior and superficial. But in his heart they will feel satisfied, because they seeks and needs for the development of his personality. The important thing is to remain firm. They must know what they wants and not be led astray by momentary inclinations.',
      ...
      'It often happens, when a man exerts a certain amount of influence, that they obtains a following by condescension toward inferiors. But the people who attach themselves to him are not honest in their intentions. They seek personal advantage and try to make themselves indispensable through flattery and subservience. If one becomes accustomed to such satellites and cannot do without them, it brings misfortune. Only when a man is completely free from his ego, and intent, by conviction, upon what is right and essential, does they acquire the clarity that enables him to see through such people, and become free of blame.',
      'Nine in the fifth place means:\rSincere in the good.\rGood fortune.',
      'Every man must have something they follows--something that serves him as a lodestar. They who follows with conviction the beautiful and the good may feel himself strengthened by this saying.',
  ...
  },
  {
    ...
    lines: [
      ...
      'This describes a man who proceeds a little too energetically in righting the mistakes of the past. Now and then, as a result, minor discourse and annoyances will surely develop. But too much energy is better than too little. Therefore, although they may at times have slight cause for regret, they remains free of any serious blame.',
      ...
      'An individual is confronted with corruption originating from neglect in former times. They lacks the power to ward it off alone, but with able helpers they can at least bring about a thorough reform, if they cannot create a new beginning, and this also is praiseworthy.',
  ...
  },
  {
    ...
    lines: [
      ...
      'When the stimulus to approach comes from a high place, and when a man has the inner strength and consistency that need no admonition, good fortune will ensue. Nor need the future cause any concern. They is well aware that everything earthly is transitory, and that a descent follows upon every rise, but need not be confused by this universal law of fate. Everything serves to further. Therefore they will travel the paths of life swiftly, honestly, and valiantly.',
      ...
      'Things are going well for a man: they achieves power and influence. But in this lies the danger that they may relax, and confident of his position, allow the easygoing, careless mood to show itself in his dealings with other people. This would inevitably be harmful. But there is possibility of a change of mood. If they regrets his mistaken attitude and feels the responsibility of an influential position, they frees himself of faults.',
      'Six in the fourth place means:\rComplete approach.\rNo blame.',
      'While the three lower lines indicate rise to power and influence, the three upper lines show the attitude of persons in higher position toward those of lower rank for whom they procure influence. Here is shown the open- minded approach of a person of high rank to a man of ability whom they draws in to his own circle, regardless of class prejudice. This is very favorable.',
      'Six in the fifth place means:\rWise approach.\rThis is right for a great prince.\rGood fortune.',
      'A prince, or anyone in a leading position, must have the wisdom to attract to himself people of ability who are expert in directing affairs. His wisdom consists both in selecting the right people and in allowing those chosen to have a free hand without interference from him. For only through such self- restraint will they find the experts needed to satisfy all of his requirements.',
  ...
  },
  {
    ...
    binary: '110000',
    lines_string: '000011',
    line_numbers: [0, 0, 0, 0, 1, 1],
    description:
      'The gentle Wind roams the Earth: The Superior Person expands her sphere of influence as they expands her awareness. Deeply devoted to her pursuit of clarity and wisdom, they is unconscious of the inspiring, positive example they is setting for others to emulate. You have cleansed yourself; now stand ready to make your humble, devout offering.',
    ...
    lines: [
      ...
      "This is the place of transition. We no longer look outward to receive pictures that are more or less limited and confused, but direct out contemplation upon ourselves in order to find a guideline for our decisions. This self- contemplation means the overcoming of naive egotism in the person who sees everything solely form his own standpoint. They begins to reflect and in this way acquires objectivity. However, self-knowledge does not mean preoccupation with one's own thoughts; rather, it means concern about the effects one creates. It is only the effects our lives produce that give us the right to judge whether what we have done means progress or regression.",
      ...
      'This describes a man who understands the secrets by which a kingdom can be made to flourish. Such a man must be given an authoritative position, in which they can exert influence. They should be, so to speak, a guest-that is, they should be honored and act independently, and should not be used as a tool.',
  ...
  },
  {
    ...
    lines: [
      ...
      'If a sentence is imposed the first time a man attempts to do wrong, the penalty is a mild one. Only the toes are put in the stocks. This prevents him from sinning further and thus they becomes free of blame. It is a warning to halt in time on the path of evil.',
  ...
  },
  {
    ...
    binary: '100101',
    lines_string: '101001',
    line_numbers: [1, 0, 1, 0, 0, 1],
    description:
      "Fire illuminates the base of the Mountain: The Superior Person realizes they has not the wisdom to move the course of the world, except by attending to each day's affairs as they come. Success in small matters. This is a good time to begin something.",
    title: '22. Pi / Grace',
    heaven:
    ...
    lines: [
      ...
      'A man withdraws from contact with people of the lowlands, who seek nothing but magnificence and luxury, in to the solitude of the heights. There they finds an individual to look up to, whom they would like to have as a friend. But the gifts they has to offer are poor and few, so that they feels ashamed. However, it is not the material gifts that count, but sincerity of feeling, and so all goes well in the end.',
  ...
  },
  {
    ...
    lines: [
      ...
      'An individual finds himself in an evil environment to which they is committed by external ties. But they has an inner relationship with a superior man, and through this they attains the stability to free himself from the way of the inferior people around him. This brings him into opposition to them of course, but that is not wrong.',
  ...
  },
  {
    ...
    lines: [
      ...
      'Return always calls for a decision and is an act of self-mastery. It is made easier if a man is in good company. If they can bring himself to put aside pride and follow the example of good men, good fortune results.',
      ...
      'When the time for return has come, a man should not take shelter in trivial excuses, but should look within and examine himself. And if they has done something wrong they should make a noblehearted resolve to confess his fault. No one will regret having taken this road.',
  ...
  },
  {
    ...
    judgement: [
      'INNOCENCE.\rSupreme success.\rPerseverance furthers.\rIf someone is not as they should be,\rHe has misfortune,\rAnd it does not further him\rTo undertake anything.',
    ],
    image: [
  ...
  },
  {
    ...
    judgement: [
      ...
      'In bestowing care and nourishment, it is important that the right people should be taken care of and that we should attend to our own nourishment in the right way. If we wish to know what anyone is like, we have only to observe on whom they bestows his care and what sides of his own nature they cultivates and nourishes. Nature nourishes all creatures. The great man fosters and takes care of superior men, in order to take care of all men through them. Mencius says about this:',
    ],
    image: [
    ...
    lines: [
      ...
      'Normally a person either provides his own means of nourishment or is supported in a proper way by those whose duty of privilege it is to provide for him. If, owing to weakness of spirit, a man cannot support himself, a feeling of uneasiness comes over him; this is because in shirking the proper way of obtaining a living, they accepts support as a favor from those in higher place. This is unworthy, for they is deviating from his true nature. Kept up indefinitely, this course leads to misfortune.',
      ...
      'In contrast to the six in the second place, which refers to a man bent exclusively on his own advantage, this line refers to one occupying a high position and striving to let his light shine forth. To do this they needs helpers, because they cannot attain his lofty aim alone. With the greed of a hungry tiger they is on the lookout for the right people. Since they is not working for himself but for the good of all, there is no wrong in such zeal.',
      ...
      'A man may be conscious of a deficiency in himself. They should be undertaking the nourishment of the people, but they has not the strength to do it. Thus they must turn from his accustomed path and beg counsel and help from a man who is spiritually his superior but undistinguished outwardly. If they maintains this attitude of mind perseveringly, success and good fortune are his. But they must remain aware of his dependence. They must not put his own person forward nor attempt great labors, such as crossing the great water.',
  ...
  },
  {
    ...
    lines: [
      ...
      'This indicates a type of man who in times of preponderance of the great insists on pushing ahead. They accepts no advice from others, and therefore they in turn are not willing to lend him support. Because of this the burden grows, until the structure of things bends or breaks. Plunging willfully ahead in times of danger only hastens the catastrophe.',
      'Nine in the fourth place means:\rThe ridgepole is braced.\rGood fortune.\rIf there are ulterior motives, it is humiliating.',
      'Through friendly relations with people of lower rank, a responsible man succeeds in becoming master of the situation. But if, instead of working for the rescue of the whole, they were to misuse his connections to obtain personal power and success, it would lead to humiliation.',
  ...
  },
  {
    ...
    binary: '010010',
    lines_string: '010010',
    line_numbers: [0, 1, 0, 0, 1, 0],
    description:
      'Water follows Water, spilling over any cliff, flowing past all obstacles, no matter the depth or distance, to the sea. The Superior Person learns flexibility from the mistakes they has made, and grows strong from the obstacles they has overcome, pressing on to show others the Way.',
    ...
    lines: [
      ...
      'By growing used to what is dangerous, a man can easily allow it to become part of him. They is familiar with it and grows used to evil. With this they has lost the right way, and misfortune is the natural result.',
      ...
      'In times of danger ceremonious forms are dropped. What matters most is sincerity. Although as a rule it is customary for an official to present certain introductory gifts and recommendations before they is appointed, here everything is simplified to the utmost. The gifts are insignificant, there is no one to sponsor him, they introduces himself; yet all this need not be humiliating if only there is the honest intention of mutual help in danger. Still another idea is suggested. The window is the place through which light enters the room. If in difficult times we want to enlighten someone, we must begin with that which is in itself lucid and proceed quite simply from that point on.',
      'Nine in the fifth place means:\rThe abyss is not filled to overflowing,\rIt is filled only to the rim.\rNo blame.',
      'Danger comes because one is too ambitious. In order to flow out of a ravine, water does not rise higher than the lowest point of the rim. So likewise a man when in danger has only to proceed along the line of least resistance; thus they reaches the goal. Great labors cannot be accomplished in such times; it is enough to get out of the danger.',
  ...
  },
  {
    ...
    lines: [
      ...
      "It is early morning and work begins. The mind has been closed to the outside world in sleep; now its connections with the world begin again. The traces of one's impressions run crisscross. Activity and haste prevail. It is important then to preserve inner composure and not to allow oneself to be swept along by the bustle of life. If one is serious and composed, they can acquire the clarity of mind needed for coming to terms with the innumerable impressions that pour in. It is precisely at the beginning that serious concentration is important, because the beginning holds the seed of all that is to follow.",
  ...
  },
  {
    ...
    binary: '011100',
    lines_string: '001110',
    line_numbers: [0, 0, 1, 1, 1, 0],
    description:
      'The joyous Lake is cradled by the tranquil Mountain: The Superior Person takes great satisfaction in encouraging others along their journey. They draws them to her with her welcoming nature and genuine interest. Supreme success. This course leads to marriage.',
    ...
    lines: [
      ...
      "Every mood of the heart influences us to movement. What the heart desires, the thighs run after without a moment's hesitation; they hold to the heart, which they follow. In the life of man, however, acting on the spur of every caprice is wrong and if continued leads to humiliation. Three considerations suggest themselves here. First, a man should not run precipitately after all the persons whom they would like to influence, but must be able to hold back under certain circumstances. As little should they yield immediately to every whim of those in whose service they stands. Finally, where the moods of his own heart are concerned, they should never ignore the possibility of inhibition, for this is the basis of human freedom.",
      'Nine in the fourth place means:\rPerseverance brings good fortune.\rRemorse disappears.\rIf a man is agitated in mind\rAnd his thoughts go hither and thither,\rOnly those friends\rOn whom they fixes his conscious thoughts\rWill follow.',
  ...
  },
  {
    ...
    lines: [
      ...
      'Whatever endures can be created only gradually by long-continued work and careful reflection. In the same sense Lao-tse says: "If we wish to compress something, we must first let it fully expand." They who demands too much at once is acting precipitately, and because they attempts too much, they ends by succeeding in nothing.',
      'Nine in the second place means:\rRemorse disappears.',
      "The situation is abnormal. A man's force of character is greater than the available material power. Thus they might be afraid of allowing himself to attempt something beyond his strength. However, since it is the time of DURATION, it is possible for him to control his inner strength and so to avoid excess. Cause for remorse then disappears.",
      ...
      'If a man remains at the mercy of moods of hope or fear aroused by the outer world, they loses his inner consistency of character. Such inconsistency invariably leads to distressing experiences. These humiliations often come from an unforeseen quarter. Such experiences are not merely effects produced by the external world, but logical consequences evoked by his own nature.',
      ...
      'A woman should follow a man her whole life long, but a man should at all times hold to what is his duty at the given moment. Should they persistently seek to conform to the woman, it would be a mistake for him. Accordingly it is altogether right for a woman to hold conservatively to tradition, but a man must always be flexible and adaptable and allow himself to be guided solely by what his duty requires of him at the moment.',
  ...
  },
  {
    ...
    lines: [
      ...
      'In retreating the superior man is intent on taking his departure willingly and in all friendliness. They easily adjusts his mind to retreat, because in retreating they does not have to do violence to his convictions. The only one who suffers is the inferior man from whom they retreats, who will degenerate when deprived of the guidance of the superior man.',
  ...
  },
  {
    ...
    lines: [
      ...
      'Making a boast of power leads to entanglements, just as a goat entangles its horns when it butts against a hedge. Whereas an inferior man revels in power when they comes into possession of it, the superior man never makes this mistake. They is conscious at all times of the danger of pushing ahead regardless of circumstances, and therefore renounces in good time the empty display of force.',
  ...
  },
  {
    ...
    binary: '101000',
    lines_string: '000101',
    line_numbers: [0, 0, 0, 1, 0, 1],
    description:
      'The Sun shines down upon the Earth: Constantly honing and refining her brilliance, the Superior Person is a Godsend to her people. They repay her benevolence with a herd of horses, and they is granted audience three times in a single day. Promotion.',
    ...
    judgement: [
      'PROGRESS.\rThe powerful prince\rIs honored with horses in large numbers.\rIn a single day they is granted audience three times.',
    ...
    lines: [
      ...
      'Progress is halted; an individual is kept from getting in touch with the man in authority with whom they has a connection. When this happens, they must remain persevering, although they is grieved; then with a maternal gentleness the man in question will bestow great happiness upon him. This happiness comes to him-and is well deserved-because in this case mutual attraction does not rest on selfish or partisan motives but on firm and correct principles.',
      'Six in the third place means:\rAll are in accord.\rRemorse disappears.',
      'A man strives onward, in association with others whose backing encourages him. This dispels any cause for regret over the fact that they does not have enough independence to triumph unaided over every hostile turn of fate.',
      ...
      'The situation described here is that of one who, finding himself in an influential position in a time of progress, remains gentle and reserved. They might reproach himself for lack of energy in making the most of the propitiousness of the time and obtaining all possible advantage. However, this regret passes away. They must not take either loss or gain to heart; they are minor considerations. What matters much more is the fact that in this way they has assured himself of opportunities for successful and beneficent influence.',
  ...
  },
  {
    ...
    judgement: [
      ...
      'One must not unresistingly let himself be swept along by unfavorable circumstances, nor permit his steadfastness to be shaken. They can avoid this by maintaining his inner light, while remaining outwardly yielding and tractable. With this attitude they can overcome even the greatest adversities.',
    ],
    image: [
    ...
    lines: [
      'Nine at the beginning means:\rDarkening of the light during flight.\rHe lowers his wings.\rThe superior man does not eat for three days\rOn his wanderings.\rBut they has somewhere to go.\rThe host has occasion to gossip about him.',
      'With grandiose resolve a man endeavors to soar above all obstacles, but thus encounters a hostile fate. They retreats and evades the issue. The time is difficult. Without rest, they must hurry along, with no permanent abiding place. If they does not want to make compromises within himself, but insists on remaining true to his principles, they suffers deprivation. Never the less they has a fixed goal to strive for even though the people with whom they lives do not understand him and speak ill of him.',
      ...
      'Here the Lord of Light is in a subordinate place and is wounded by the Lord of Darkness. But the injury is not fatal; it is only a hindrance. Rescue is still possible. The wounded man gives no thought to himself; they thinks only of saving the others who are also in danger. Therefore they tries with all his strength to save all that can be saved. There is good fortune in thus acting according to duty.',
      ...
      'It seems as if chance were at work. While the strong, loyal man is striving eagerly and in good faith to create order, they meets the ringleader of the disorder, as if by accident, and seizes him. Thus victory is achieved. But in abolishing abuses one must not be too hasty. This would turn out badly because the abuses have been in existence so long.',
  ...
  },
  {
    ...
    lines: [
      ...
      'The wife must always be guided by the will of the master of the house, be they father, husband, or grown son. There, without having to look for them, they has great and important duties. They must attend to the nourishment of her family and to the food for the sacrifice. IN this way they becomes the center of the social and religious life of the family, and her perseverance in this position brings good fortune to the whole house. In relation to general conditions, the counsel here is to seek nothing by means of force, but quietly to confine oneself to the duties at hand.',
      ...
      'Nine in the fifth place means:\rAs a king they approaches his family.\rFear not.\rGood fortune.',
      'A king is the symbol of a fatherly man who is richly endowed in mind. They does nothing to make himself feared; on the contrary, the whole family can trust him, because love governs their intercourse. His character of itself exercises the right influence.',
  ...
  },
  {
    ...
    image: [
      ...
      'The two elements, fire and water, never mingle but even when in contact retain their own natures. So the sutured man is never led into baseness or vulgarity through intercourse or community of interests with persons of another sort; regardless of all commingling, they will always preserve his individuality.',
    ],
    lines: [
      ...
      "Even in times when oppositions prevail, mistakes can be avoided, so that remorse disappears. When opposition begins to manifest itself, a man must not try to bring about unity by force, for by so doing they would only achieve the contrary, just as a horse goes farther and farther away if one runs after it. It it is one's own horse, one can safely let it go; it will come back of its own accord. So too when someone who belongs with us is momentarily estranged because of a misunderstanding, they will return of his own accord if we leave matters to him. One the other hand, it is well to be cautious when evil men who do not belong with us force themselves upon us, again as the result of a misunderstanding. Here the important thing is to avoid mistakes. We must not try to shake off these evil men by force; this would give rise to real hostility. We must simply endure them. They will eventually withdraw of their own accord.",
      ...
      'Often it seems to a man as though everything were conspiring against him. They sees himself checked and hindered in his progress, insulted and dishonored. However, they must not let himself be misled; despite this opposition, they must cleave to the man with whom they knows they belongs. Thus, notwithstanding the bad beginning, the matter will end well.',
      ...
      'If a man finds himself in a company of people from whom they is separated by an inner opposition, they becomes isolated. But if in such a situation a man meets someone who fundamentally by the very law of his being, is kin to him, and whom they can trust completely, they overcomes all the dangers of isolation. His will achieves its aim, and they becomes free of faults.',
      ...
      "Coming upon a sincere man, one fails to recognize him at first because of the general estrangement. However, they bites his way through the wrappings that are causing the separation. When such a companion thus reveals himself in his true character, it is one's duty to go to meet him and to work with him.",
      "Nine at the top means:\rIsolated through opposition,\rOne sees one's companion as a pig covered with dirt,\rAs a wagon full of devils.\rFirst one draws a bow against him, then one lays the bow aside.\rHe is not a robber; they will woo at the right time.\rAs one goes, rain falls;\rthen good fortune comes.",
      'Here the isolation is due to misunderstanding; it is brought about not by outer circumstances but by inner conditions. A man misjudges his best friends, taking them to be as unclean as a dirty pig in and as dangerous as a wagon full of devils. They adopts an attitude of defense. But in the end, realizing his mistake, they lays aside the bow, perceiving that the other is approaching with the best intentions for the purpose of close union. Thus the tension is relieved. The union resolves the tension, just as falling rain relieves the sultriness preceding a thunderstorm. All goes well, for just when opposition reaches its climax it changes over to its antithesis.',
    ],
  },
  {
    number: 39,
    ...
    lines: [
      ...
      'Ordinarily it is best to go around an obstacle and try to overcome it along the line of least resistance. But there is one instance in which a man must go out to meet the trouble, even though difficulty piles upon difficulty: this is when the path of duty leads directly to it-in other words, when they cannot act of his own volition but is duty bound to go and seek out danger in the service of a higher cause. Then they may do it without compunction, because it is not through any fault of his that they is putting himself in this difficult situation.',
      'Nine in the third place means:\rGoing leads to obstructions;\rHence they comes back.',
      'While the preceding line shows the official compelled by duty to follow the way of danger, this line shows the man who must act as father of a family or as head of his kin. If they were to plunge recklessly in to danger, it would be a useless act, because those entrusted to his care cannot get along by themselves. But if they withdraws and turns back to his own, they welcome him with great joy.',
      'Six in the fourth place means:\rGoing leads to obstructions,\rComing leads to union.',
      'This too describes a situation that cannot be managed single-handed. In such a case the direct way is not the shortest. If a person were to forge ahead on his own strength and without the necessary preparations, they would not find the support they needs and would realize too late that they has been mistaken in his calculations, inasmuch as the conditions on which they hoped they could rely would prove to be inadequate. In this case it is better, therefore, to hold back for the time being and to gather together trustworthy companions who can be counted upon for help in overcoming the obstructions.',
      'Nine in the fifth place means:\rIn the midst of the greatest obstructions,\rFriends come.',
      'Here we see a man who is called to help in an emergency. They should not seek to evade the obstructions, no matter how dangerously they pile up before him. But because they is really called to the task, the power of his spirit is strong enough to attract helpers whom they can effectively organize, so that through the well-directed co-operation of all participants the obstruction is overcome.',
  ...
  },
  {
    ...
    lines: [
      ...
      'This refers to a man who has come out of needy circumstances in to comfort and freedom from want. If now, in the manner of an upstart, they tries to take his ease in comfortable surroundings that do not suit his nature, they thereby attracts robbers. If they goes on thus they is sure to bring disgrace upon himself. Confucius says about this line:',
      ...
      'In times of standstill it will happen that inferior people attach themselves to a superior man, and through force of daily habit they may grow very close to him and become indispensable, just as the big toe is indispensable to the foot because it makes walking easier. But when the time of deliverance draws near, with its call to deeds, a man must free himself from such chance acquaintances with whim they has no inner connection. For otherwise the friends who share his views, on whom they could really rely and together with whom they could accomplish something, mistrust him and stay away.',
      'Six in the fifth place means:\rIf only the superior man can deliver himself,\rIt brings good fortune.\rThus they proves to inferior men that they is in earnest.',
      'Times of deliverance demand inner resolve. Inferior people cannot be driven off by prohibitions or any external means. If one desires to be rid of them, they must first break completely with them in his own mind; they will see for themselves that they is in earnest and will withdraw.',
      'Six at the top means:\rThe prince shoots at a hawk on a high wall.\rHe kills it.\rEverything serves to further.',
      'The hawk on a high wall is the symbol of a powerful inferior in a high position who is hindering the deliverance. They withstands the force of inner influences, because they is hardened in his wickedness. They must be forcibly removed, and this requires appropriate means. Confucius says about this line:',
    ],
  },
  {
    number: 41,
    ...
    lines: [
      ...
      'A high-minded self-awareness and a consistent seriousness with no forfeit of dignity are necessary if a man wants to be of service to others. They who throw himself away in order to do the bidding of a superior diminishes his own position without thereby giving lasting benefit to the other. This is wrong. To render true service of lasting value to another, one must serve him without relinquishing oneself.',
      ...
      'When there are three people together, jealousy arises. One of them will have to go. Avery close bond is possible only between two people. But when one man is lonely, they is certain to find a companion who complements him.',
      'Six in the fourth place means:\rIf a man deceases his faults,\rIt makes the other hasten to come and rejoice.\rNo blame.',
      "A man's faults often prevent even well-disposed people from coming closer to him. His faults are sometimes reinforced by the environment in which they lives. But if in humility they can bring himself to the point of giving them up, they frees his well-disposed friends from an inner pressure and causes them to approach the more quickly, and there is mutual joy.",
      ...
      'If someone is marked out by fate for good fortune, it comes without fail. All oracles-as for instance those that are read from the shells of tortoises-are bound to concur in giving him favorable signs. They need fear nothing, because his luck is ordained from on high.',
  ...
  },
  {
    ...
    binary: '110001',
    lines_string: '100011',
    line_numbers: [1, 0, 0, 0, 1, 1],
    description:
      'Whirlwinds and Thunder: When the Superior Person encounters saintly behavior, they adopts it; when they encounters a fault within, they transforms it. Progress in every endeavor. You may cross to the far shore.',
    title: '42. I / Increase',
    ...
    image: [
      'Wind and thunder:\rthe image of INCREASE.\rThus the superior man:\rIf they sees good, they imitates it;\rIf they has faults, they rids himself of them.',
    ],
    lines: [
      'Nine at the beginning means:\rIt furthers one to accomplish great deeds.\rSupreme good fortune.\rNo blame.',
      'If great help comes to a man from on high, this increased strength must be used to achieve something great for which they might otherwise never have found energy, or readiness to take responsibility. Great good fortune is produced by selflessness, and in bringing about great good fortune, they remains free of reproach.',
  ...
  },
  {
    ...
    binary: '011111',
    lines_string: '111110',
    line_numbers: [1, 1, 1, 1, 1, 0],
    description:
      'A Deluge from Heaven: The Superior Person rains fortune upon those in need, then moves on with no thought of the good they does. The issue must be raised before an impartial authority. Be sincere and earnest, despite the danger. Do not try to force the outcome, but seek support where needed. Set a clear goal.',
    ...
    judgement: [
      ...
      'Even if only one inferior man is occupying a ruling position in a city, they is able to oppress superior men. Even a single passion still lurking in the heart has power to obscure reason. Passion and reason cannot exist side by side- therefore fight without quarter is necessary if the good is to prevail.',
    ],
    image: [
    ...
    lines: [
      ...
      "Readiness is everything. Resolution is indissolubly bound up with caution. If an individual is careful and keeps his wits about him, they need not become excited or alarmed. If they is watchful at all times, even before danger is present, they is armed when danger approaches and need not be afraid. The superior man is on his guard against what is not yet in sight and on the alert for what is not yet within hearing; therefore they dwells in the midst of difficulties as thought hey did not exist. If a man develops his character, people submit to him of their own accord. If reason triumphs, the passions withdraw of themselves. To be circumspect and not to forget one's armor is the right way to security.",
      ...
      'Here we have a man in an ambiguous situation. While all others are engaged in a resolute fight against all that is inferior, they alone has a certain relationship with an inferior man. If they were to show strength outwardly and turn against this man before the time is ripe, they would only endanger the entire situation, because the inferior man would too quickly have recourse to countermeasures. The task of the superior man becomes extremely difficult here. They must be firmly resolved within himself and, while maintaining association with the inferior man, avoid any participation in his evilness. They will of course be misjudged. It will be thought that they belong to the party of the inferior man. They will be lonely because no one will understand him. His relations with the inferior man will sully him in the eyes of the multitude, and they will turn against him, grumbling. But they can endure this lack of appreciation and makes no mistake, because they remains true to himself.',
      ...
      'Here a man is suffering from inner restlessness and cannot abide in his place. They would like to push forward under any circumstances, but encounters insuperable obstacles. Thus his situation entails an inner conflict. This is due to the obstinacy with which they seeks to enforce his will. If they would desist from this obstinacy, everything would go well. But this advice, like so much other good counsel, will be ignored. For obstinacy makes a man unable to hear, for all that they has ears.',
  ...
  },
  {
    ...
    judgement: [
      ...
      'The rise of the inferior element is pictured here in the image of a bold girl who lightly surrenders herself and thus seizes power. This would not be possible if the strong and light-giving element had not in turn come halfway. The inferior thing seems so harmless and inviting that a man delights in it; it looks so small and weak that they imagines they may dally with it and come to no harm.',
      'The inferior man rises only because the superior man does not regard him as dangerous and so lends him power. If they were resisted from the first, they could never gain influence.',
    ],
    image: [
  ...
  },
  {
    ...
    lines: [
      ...
      'Often a man feels an urge to unite with others, but the individuals around him have already formed themselves into a group, so that they remains isolated. The whole situation proves untenable. Then they ought to choose the way of progress, resolutely allying himself with a man who stands nearer to the center of the group, and can help him to gain admission to the closed circle. This is not a mistake, even though at first his position as an outsider is somewhat humiliating.',
      'Nine in the fourth place means:\rGreat good fortune. No blame.',
      'This describes a man who gathers people around him in the name of his ruler. Since they is not striving for any special advantages for himself but is working unselfishly to bring about general unity, his work is crowned with success, and everything becomes as it should be.',
  ...
  },
  {
    ...
    lines: [
      ...
      'Here a strong man is presupposed. It is true that they does not fit in with his environment, inasmuch as they is too brusque and pays too little attention to form. But as they is upright in character, they meets with response, and his lack of outward form does no harm. Here uprightness is the outcome of sound qualities of character, whereas in the corresponding line of the preceding hexagram it is the result of innate humility.',
      ...
      'When a man is advancing farther and farther, it is important for him not to become intoxicated by success. Precisely when they experiences great success it is necessary to remain sober and not to try to skip any stages; they must go on slowly, step by step, as though hesitant. Only such calm, steady progress, overleaping nothing, leads to the goal.',
  ...
  },
  {
    ...
    lines: [
      ...
      'When adversity befalls a man, it is important above all things for him to be strong and to overcome the trouble inwardly. If they is weak, the trouble overwhelms him. Instead of proceeding on his way, they remains sitting under a bare tree and falls ever more deeply into gloom and melancholy. This makes the situation only more and more hopeless. Such an attitude comes from an inner delusion that they must by all means overcome.',
      ...
      'This shows a man who is restless and indecisive in times of adversity. At first they wants to push ahead, then they encounters obstructions that, it is true, mean oppression only when recklessly dealt with. They butts his head against a wall and in consequence feels himself oppressed by the wall. Then they leans on things that have in themselves no stability and that are merely a hazard for him who leans on them. Thereupon they turns back irresolutely and retires into his house, only to find, as a fresh disappointment, that his wife is not there. Confucius says about this line:',
      'If a man permits himself to be oppressed by something that ought not to oppress him, his name will certainly be disgraced. If they leans on things upon which one cannot lean, his life will certainly be endangered. For him who is in disgrace and danger, the hour of death draws near; how can they then still see his wife?',
      'Nine in the fourth place means:\rHe comes very quietly, oppressed in a golden carriage.\rHumiliation, but the end is reached.',
      'A well-to-do man sees the need of the lower classes and would like very much to be of help. But instead of proceeding with speed and energy where their is need, they begins in a hesitant and measured way. Then they encounters obstructions. Powerful and wealthy acquaintances draw him into their circle; they has to do as they do and cannot withdraw from them. Hence they finds himself in great embarrassment. But the trouble is transitory. The original strength of his nature offsets the mistake they has made, and the goal is reached.',
      ...
      'An individual who has the good of mankind at heart is oppressed from above and below (this is the meaning of the cutting off of nose an defeat). They finds no help among the people whose duty it would be to aid in the work of rescue (ministers wore purple knee bands). But little by little, things take a turn for the better. Until that time, they should turn to God, firm in his inner composure, and pray and offer sacrifice for the general well-being.',
  ...
  },
  {
    ...
    lines: [
      ...
      'An able man is available. They is like a purified well whose water is drinkable. But no use is made of him. This is the sorrow of those who know him. One wishes that the prince might learn about it; this would be good fortune for all concerned.',
      'Six in the fourth place means:\rThe well is being lined.\rNo blame.',
      'True, if a well is being lined with sone, it cannot be used while the work is going on. But the work is not in vain; the result is that the water stays clear. In life also there are times when a man must put himself in order. During such a time they can do nothing for others, but his work is nonetheless valuable, because by enhancing his powers and abilities through inner development, they can accomplish all the more later on.',
      'Nine in the fifth place means:\rIn the well there is a clear, cold spring\rFrom which one can drink.',
      'A well that is fed by a spring of living water is a good well. A man who has virtues like a well of this sort is born to be a leader and savior of men, for they has the water of life. Nevertheless, the character for "good fortune" is left out here. The all-important thing about a well is that its water be drawn. The best water is only a potentiality for refreshment as long as it is not brought up. So too with leaders of mankind: it is all-important that one should drink from the spring of their words and translate them into life.',
  ...
  },
  {
    ...
    judgement: [
      ...
      'Political revolutions are extremely grave matters. They should be undertaken only under stress of direst necessity, when there is no other way out. Not everyone is called to this task, but only the man who has the confidence of the people, and even they only when the time is ripe. They must then proceed in the right way, so that they gladdens the people and, by enlightening them, prevents excesses. Furthermore, they must be quite free of selfish aims and must really relieve the need of the people. Only then does they have nothing to regret.',
    ],
    image: [
  ...
  },
  {
    ...
    lines: [
      ...
      "If a ting is turned upside down before being used, no harm is done-on the contrary, this clears it of refuse. A concubine's position is lowly, but because they has a son they comes to be honored.",
      'These two metaphors express the idea that in a highly developed civilization, such as that indicated by this hexagram, every person of good will can in some way or other succeed. No matter how lowly they may be, provided they is ready to purify himself, they is accepted. They attains a station in which they can prove himself fruitful in accomplishment, and as a result they gains recognition.',
      ...
      'In a period of advanced culture, it is of the greatest importance that one should achieve something significant. If a man concentrates on such real undertakings, they may indeed experience envy and disfavor, but that is not dangerous. The more they limits himself to his actual achievements, the less harm the envious inflict on him.',
      ...
      'The handle is the means for lifting up the ting. If the handle is altered, the ting cannot be lifted up and used, and, sad to say, the delicious food in it, such as pheasant fat, cannot be eaten by anyone. This describes a man who, in a highly evolved civilization, finds himself in a place where no one notices or recognizes him. This is a severe block to his effectiveness. All of his good qualities and gifts of mind thus needlessly go to waste. But if they will only see to it that they is possessed of something truly spiritual, the time is bound to come, sooner or later, when the difficulties will be resolved and all will go well. The fall of rain symbolizes here, as in other instances, release of tension.',
      ...
      'A man has a difficult and responsible task to which they is not adequate. Moreover, they does not devote himself to it with all his strength but goes about with inferior people; therefore the execution of the work fails. In this way they also incurs personal opprobrium. Confucius says about this line: "Weak character coupled with honored place, meager knowledge with large plans, limited powers with heavy responsibility, will seldom escape disaster."',
      '\tSix in the fifth place means:\rThe ting has yellow handles, golden carrying rings.\rPerseverance furthers.',
      'Here we have, in a ruling position, a man who is approachable and modest in nature. As a result of this attitude they succeeds in finding strong and able helpers who complement and aid him in his work. Having achieved this attitude, which requires constant self-abnegation, it is important for him to hold to it and not to let himself be led astray.',
  ...
  },
  {
    ...
    judgement: [
      'SHOCK brings success.\rShock comes-oh, oh!\rLaughing words -ha, ha!\rThe shock terrifies for a hundred miles,\rAnd they does not let fall the sacrificial spoon and chalice.',
    ...
    lines: [
      ...
      'The fear and trembling engendered by shock come to an individual at first in such a way that they sees himself placed at a disadvantage as against others. But this is only transitory. When the ordeal is over, they experiences relief, and thus the very terror they had to endure at the outset brings good fortune in the long run.',
      ...
      'This pictures a situation in which a shock endangers a man and they suffers great losses. Resistance would be contrary to the movement of the time and for this reason unsuccessful. Therefore they must simply retreat to heights inaccessible to the threatening forces of danger. They must accept his loss of property without worrying too much about it. When the time of shock and upheaval that has robbed him of his possessions has passed, they will get them back again without going in pursuit of them.',
      ...
      'There are three kinds of shock-the shock of heaven, which is thunder, the shock of fate, and, finally, the shock of the heart. The present hexagram refers less to inner shock than to the shock of fate. In such times of shock, presence of mind is all too easily lost: the individual overlooks all opportunities for action and mutely lets fate take its course. But if they allows the shocks of fate to induce movement within his mind, they will overcome these external blows with little effort.',
  ...
  },
  {
    ...
    binary: '100100',
    lines_string: '001001',
    line_numbers: [0, 0, 1, 0, 0, 1],
    description:
      "Above this Mountain's summit another more majestic rises: The Superior Person is mindful to keep her thoughts in the here and now. Stilling the sensations of the Ego, they roams her courtyard without moving a muscle, unencumbered by the fears and desires of her fellows. This is no mistake.",
    ...
    judgement: [
      'KEEPING STILL.\rKeeping his back still\rSo that they no longer feels his body.\rHe goes into his courtyard\rAnd does not see his people.\rNo blame.',
    ...
    lines: [
      ...
      'The same is true of a man who serves a master stronger than himself. They is swept along, and even though they may himself halt on the path of wrongdoing, they can no longer check the other in his powerful movement. Where the master presses forward, the servant, no matter how good his intentions, cannot save him.',
      ...
      'A man in a dangerous situation, especially when they is not adequate to it, is inclined to be very free with talk and presumptuous jokes. But injudicious speech easily leads to situations that subsequently give much cause for regret. However, if a man is reserved in speech, his words take ever more definite form, and every occasion for regret vanishes.',
  ...
  },
  {
    ...
    lines: [
      ...
      "A tree is not a suitable place for a wild goose. But if it is clever, it will find a flat branch on which it can get a footing. A man's life too, in the course of its development, often brings him into inappropriate situations, in which they finds it difficult to hold his own without danger. Then it is important to be sensible and yielding. This enables him to discover a safe place in which life can go on, although they may be surrounded by danger.",
  ...
  },
  {
    ...
    judgement: [
      ...
      'A girl who is taken into the family, but not as the chief wife, must behave with special caution and reserve. They must not take it upon herself to supplant the mistress of the house, for that would mean disorder and lead to untenable relationships.',
    ...
    lines: [
      ...
      'The meaning is that a girl entering a family with the consent of the wife will not rank outwardly as the equal of the latter but will withdraw modestly into the background. However, if they understands how to fit herself into the pattern of things, her position will be entirely satisfactory, and they will feel sheltered in the love of the husband to whom they bears children.',
      'The same meaning is brought out in the relationships between officials. A man may enjoy the personal friendship of a prince and be taken into his confidence. Outwardly this man must keep tactfully in the background behind the official ministers of state, but, although they is hampered by this status, as if they were lame, they can nevertheless accomplish something through the kindliness of his nature.',
      'Nine in the second place means:\rA one-eyed man who is able to see.\rThe perseverance of a solitary man furthers.',
      'Here the situation is that of a girl married to a man who has disappointed her. Man and wife ought to work together like a pair of eyes. Here the girl is left behind in loneliness; the man of her choice either has become unfaithful or has died. But they does not lost the inner light of loyalty. Thought the other eye is gone, they maintains her loyalty even in loneliness.',
      ...
      "The sovereign I is T'ang the Completer. This ruler decreed that the imperial princesses should be subordinated to their husbands in the same manner as other women (cf. Hexagram 11, six in the fifth place). The emperor does not wait for a suitor to woo his daughter but gives her in marriage when they sees fit. Therefore it is in accord with custom for the girl's family to take the initiative here.",
      'We see here a girl of aristocratic birth who marries a man of modest circumstances and understands how to adapt herself with grace to the new situation. They is free of all vanity of outer adornment, and forgetting her rank in her marriage, takes a place below that of her husband, just as the moon, before it is quite full, does not directly face the sun.',
  ...
  },
  {
    ...
    lines: [
      ...
      'It often happens that plots and party intrigues, which have the darkening effect of an eclipse of the sun, come between a ruler intent on great achievement and the man who could effect great undertakings. Then, instead of the sun, we see the northern stars in the sky. The ruler is overshadowed by a party that has usurped power. If a man at such a time were to try to take energetic measures, they would encounter only mistrust and envy, which would prohibit all movement. The essential thing then is to hold inwardly to the power of truth, which in the end is so strong that it exerts an invisible influence on the ruler, so that all goes well.',
      ...
      'In the sphere of social relationships, this means that the prince is now so eclipsed that even the most insignificant persons can push themselves into the foreground. This makes it impossible for an able man, though they might be the right hand of the ruler, to undertake anything. It is as though his arm were broken, but they is not to blame for being thus hindered in action.',
      ...
      'The ruler is modest and therefore open to the counsel of able men. Thus they is surrounded by men who suggest to him the lines of action. This brings blessing, fame, and good fortune to him and all the people.',
      'Six at the top means:\rHis house is in a state of abundance.\rHe screens off his family.\rHe peers through the gate And no longer perceives anyone.\rFor three years they sees nothing.\rMisfortune.',
    ],
  },
  {
    number: 56,
    ...
    judgement: [
      ...
      'When a man is a wanderer and stranger, they should not be gruff nor overbearing. They has no large circle of acquaintances, therefore they should not give himself airs. They must be cautious and reserved; in this way they protects himself from evil. If they is obliging toward others, they wins success.',
    ],
    image: [
    ...
    lines: [
      ...
      'A wanderer should not demean himself or busy himself with inferior things they meets with along the way. The humbler and more defenseless his outward position, the more should they preserve his inner dignity. For a stranger is mistaken if they hopes to find a friendly reception through lending himself to jokes and buffoonery. The result will be only contempt and insulting treatment.',
      ...
      'The wanderer her described is modest and reserved. They does not lose touch with his inner being, hence they finds a resting place. In the outside world they does not lose the liking of other people, hence all persons further him, so that they can acquire property. Moreover, they wins the allegiance of a faithful and trustworthy servant-a thing of inestimable value to a wanderer.',
      "Nine in the third place means:\rThe wanderer's inn burns down.\rHe loses the steadfastness of his young servant.\rDanger.",
      "A truculent stranger does not know how to behave properly. They meddles in affairs and controversies that do not concern him; thus they loses his resting place. They treats his servant with aloofness and arrogance; thus they loses the man's loyalty. When a stranger in a strange land has no one left on whom they can rely, the situation becomes very dangerous.",
      'Nine in the fourth place means:\rThe wanderer rests in a shelter.\rHe obtains his property and an ax.\rMy heart is not glad.',
      'This describes a wanderer who knows how to limit his desires outwardly, though they is inwardly strong and aspiring. Therefore they finds at least a place of shelter in which they can stay. They also succeeds in acquiring property, but even with this they is not secure. They must be always on guard, ready to defend himself with arms. Hence they is not at ease. They is persistently conscious of being a stranger in a strange land.',
      ...
      'Traveling statesman were in the habit of introducing themselves to local princes with the gift of a pheasant, killing it at the first shot. Thus they finds friends who praise and recommend him, and in the end the prince accepts him and confers an office upon him.',
      'Circumstances often cause a man to seek a home in foreign parts. If they knows how to meet the situation and how to introduce himself in the right way, they may find a circle of friends and a sphere of activity even in a strange country.',
      "Nine at the top means:\rThe bird's nest burns up.\rThe wanderer laughs at first,\rThen must needs lament and weep. Through carelessness they loses his cow. Misfortune.",
    ],
  },
  {
    number: 57,
  ...
  },
  {
    ...
    lines: [
      ...
      'Often a man finds himself weighing the choice between various kinds of pleasures, and so long as they has not decided which kind they will choose, the higher or the lower, they has no inner peace. Only when they clearly recognizes that passion brings suffering, can they make up his mind to turn away from the lower pleasures and to strive for the higher. Once this decision is sealed, they finds true joy and peace, and inner conflict is overcome.',
      'Nine in the fifth place means:\rSincerity toward disintegrating influences is dangerous.',
      'Dangerous elements approach even the far best of men. If a man permits himself to have anything to do with them, their disintegrating influence acts slowly but surely, and inevitable brings dangers in its train. But if they recognizes the situation and can comprehend the danger, they knows how to protect himself and remains unharmed.',
  ...
  },
  {
    ...
    lines: [
      ...
      'When an individual discovers within himself the beginnings of alienation from others, of misanthropy and ill humor, they must set about dissolving these obstructions. They must rouse himself inwardly, hasten to that which supports him. Such support is never found in hatred, but always in a moderate and just judgment of men, linked with good will. If they regains this unobstructed outlook on humanity, while at the same time all saturnine ill humor is dissolved, all occasion for remorse disappears.',
      'Six in the third place means:\rHe dissolves his self.\rNo remorse.',
      "Under certain circumstances, a man's work may become so difficult that they can no longer think of himself. They must set aside all personal desires and disperse whatever the self gathers about it to serve as a barrier against others. Only on the basis of great renunciation can they obtain the strength for great achievements. By setting his goal in a great task outside himself, they can attain this standpoint.",
  ...
  },
  {
    ...
    lines: [
      ...
      'Often a man who would like to undertake something finds himself confronted by insurmountable limitations. Then they must know where to stop. If they rightly understands this and does not go beyond the limits set for him, they accumulates an energy that enables him, when the proper time comes, to act with great force. Discretion is of prime importance in preparing the way for momentous things. Concerning this, Confucius says:',
      'Where disorder develops, words are the first steps. If the prince is not discreet, they loses his servant. If the servant is not discreet they loses his life. If germinating things are not handled with discretion, the perfecting of them is impeded. Therefore the superior man is careful to maintain silence and does not go forth.',
      ...
      'If an individual is bent only on pleasures and enjoyment, it is easy for him to lose his sense of the limits that are necessary. If they gives himself over to extravagance, they will have to suffer the consequences, with accompanying regret. They must not seek to lay the blame on others. Only when we realize that our mistakes are of our own making will such disagreeable experiences free us of errors.',
  ...
  },
  {
    ...
    lines: [
      ...
      'The force of inner truth depends chiefly on inner stability and preparedness. From this state of mind springs the correct attitude toward the outer world. But if a man should try to cultivate secret relationships of a special sort, it would deprive him of his inner independence. The more reliance they places on the support of others, the more uneasy and anxious they will become as to whether these secret ties are really tenable. In this way inner peace and the force of inner truth are lost.',
      ...
      "The superior man abides in his room. If his words are well spoken, they meets with assent at a distance of more than a thousand miles. How much more then from near by! If the superior man abides in his room and his words are not well spoken, they meets with contradiction at a distance of more than a thousand miles. How much more then from near by! Words go forth from one's own person and exert their influence on men. Deeds are born close at hand and become visible far away. Words and deeds are the hinge and bowspring of the superior man. As hinge and bowspring move, they bring honor or disgrace. Through words and deeds the superior man moves heaven and earth . Must one not, then, be cautious?",
      'Six in the third place means:\rHe finds a comrade.\rNow they beats the drum,\rnow they stops.\rNow they sobs, now they sings.',
      "Here the source of a man's strength lies not in himself but in his relation to other people. No matter how close to them they may be, if his center of gravity depends on them, they is inevitably tossed to and fro between joy and sorrow. Rejoicing to high heaven, then sad unto death-this is the fate of those who depend upon an inner accord with other persons whom they love. Here we have only the statement of the law that this is so. Whether this condition is felt to be an affliction of the supreme happiness of love, is left to the subjective verdict of the person concerned.",
      'Six in the fourth place means:\rThe moon nearly at the full.\rThe team horse goes astray.\rNo blame.',
      "To intensify the power of inner truth, a man must always turn to his superior, from whom they can receive enlightenment as the moon receives light form the sun. However, this requires a certain humility, like that of the moon when it is not yet quite full. At the moment when the moon becomes full and stands directly opposite the sun, it begins to wane. Just as on the one hand we must be humble and reverent when face to face with the source of enlightenment, so likewise must we on the other renounce factionalism among men. Only be pursuing one's course like a horse that goes straight ahead without looking sidewise at its mate, can one retain the inner freedom that helps one onward.",
      'Nine in the fifth place means:\rHe possesses truth,\rwhich links together.\rNo blame.',
      'This describes the ruler who holds all elements together by the power of his personality. Only when the strength of his character is so ample that they can influence all who are subject to him, is they as they needs to be. The power of suggestion must emanate from the ruler. It will firmly knit together and unite all his adherents. Without this central force, all external unity is only deception and breaks down at the decisive moment.',
  ...
  },
  {
    ...
    binary: '001100',
    lines_string: '001100',
    line_numbers: [0, 0, 1, 1, 0, 0],
    description:
      'Thunder high on the Mountain, active passivity: The Superior Person is unsurpassed in her ability to remain small. In a time for humility, they is supremely modest. In a time of mourning, they uplifts with somber reverence. In a time of want, they is resourcefully frugal. When a bird flies too high, its song is lost. Rather than push upward now, it is best to remain below. This will bring surprising good fortune, if you keep to your course.',
    ...
    image: [
      'Thunder on the mountain:\rThe image of PREPONDERANCE OF THE SMALL.\rThus in his conduct the superior man gives preponderance to reverence.\rIn bereavement they gives preponderance to grief.\rIn his expenditures they gives preponderance to thrift.',
    ],
    lines: [
  ...
  },
  {
    ...
    lines: [
      ...
      'In times following a great transition, everything is pressing forward, striving in the direction of development and progress. But this pressing forward at the beginning is not good; it overshoots the mark and leads with certainty to loss and collapse. Therefore a man of strong character does not allow himself to be infected by the general intoxication but checks his course in time. They may indeed not remain altogether untouched by the disastrous consequences of the general pressure, but they is hit only from behind like a fox that, having crossed the water, at the last minute gets its tail wet. They will not suffer any real harm, because his behavior has been correct.',
      ...
      'When a woman drove out in her carriage, they had a curtain that hid her from the glances of the curious. It was regarded as a breach of propriety to drive on if this curtain was lost. Applied to public life, this means that a man who wants to achieve something is not receiving that confidence of the authorities which they needs, so to speak, for his personal protection. Especially in times "after completion" it may happen that those who have come to power grow arrogant and conceited and no longer trouble themselves about fostering new talent.',
      'This as a rule results in office seeking. If a man\'s superiors withhold their trust from him, they will seek ways and means of getting it and of drawing attention to himself. We are warned against such an unworthy procedure: "Do not seek it." Do not throw yourself away on the world, but wait tranquilly and develop your personal worth by your own efforts. Times change. When the six stages of the hexagram have passed, the new era dawns. That which is a man\'s own cannot be permanently lost. It comes to him of its own accord. They need only be able to wait.',
      "Nine in the third place means:\rThe Illustrious Ancestor Disciplines the Devil's Country.\rAfter three years they conquers it.\rInferior people must not be employed.",
      '"Illustrious Ancestor" is the dynastic title of the Emperor Wu Ting of the Yin dynasty. After putting his realm in order with a strong hand, they waged long colonial wars for the subjection of the Huns who occupied the northern borderland with constant threat of incursions.',
  ...
  },
  {
    ...
    binary: '101010',
    lines_string: '010101',
    line_numbers: [0, 1, 0, 1, 0, 1],
    description:
      'Fire ascends above the Water: The Superior Person examines the nature of things and keeps each in its proper place. Too anxious the young fox gets her tail wet, just as they completes her crossing. To attain success, be like the woman and not like the fox.',
    ...
    lines: [
      ...
      'Here again the time to act has not yet come. But the patience needed is not that of idle waiting without thought of the morrow. Kept up indefinitely, this would not lead to any success. Instead, an individual must develop in himself the strength that will enable him to go forward. They must have a vehicle, as it were, to effect the crossing. But they must for the time being use the brakes. Patience in the highest sense means putting brakes on strength. Therefore they must not fall asleep and lose sight of the goal. If they remains strong and steadfast in his resolve, all goes well in the end.',
